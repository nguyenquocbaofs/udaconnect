...
4. `kubectl apply -f deployment/zookeeper.yaml` - Set up the service and deployment for the zookeeper
5. `kubectl apply -f deployment/kafka.yaml` - Set up the service and deployment for the Kafka
6. `kubectl apply -f deployment/udaconnect-location-consumer.yaml` - Set up the service and deployment for the location consumer service
7. `kubectl apply -f deployment/udaconnect-location-producer.yaml` - Set up the service and deployment for the location producer service
